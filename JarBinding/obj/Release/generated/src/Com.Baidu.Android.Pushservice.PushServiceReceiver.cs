...
namespace Com.Baidu.Android.Pushservice {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='com.baidu.android.pushservice']/class[@name='PushServiceReceiver']"
	[global::Android.Runtime.Register ("com/baidu/android/pushservice/PushServiceReceiver", DoNotGenerateAcw=true)]
	public partial class PushServiceReceiver : global::Android.Content.BroadcastReceiver {
		static readonly JniPeerMembers _members = new XAPeerMembers ("com/baidu/android/pushservice/PushServiceReceiver", typeof (PushServiceReceiver));
		...
		// Metadata.xml XPath constructor reference: path="/api/package[@name='com.baidu.android.pushservice']/class[@name='PushServiceReceiver']/constructor[@name='PushServiceReceiver' and count(parameter)=0]"
		[Register (".ctor", "()V", "")]
		public unsafe PushServiceReceiver () : base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			const string __id = "()V";
...
#pragma warning disable 0169
		...
		{
			var __this = global::Java.Lang.Object.GetObject<global::Com.Baidu.Android.Pushservice.PushServiceReceiver> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.baidu.android.pushservice']/class[@name='PushServiceReceiver']/method[@name='onReceive' and count(parameter)=2 and parameter[1][@type='android.content.Context'] and parameter[2][@type='android.content.Intent']]"
