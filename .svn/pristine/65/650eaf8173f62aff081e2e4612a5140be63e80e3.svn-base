...
namespace Com.Baidu.Android.Pushservice {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='com.baidu.android.pushservice']/class[@name='PushService']"
	[global::Android.Runtime.Register ("com/baidu/android/pushservice/PushService", DoNotGenerateAcw=true)]
	public partial class PushService : global::Android.App.Service {
		static readonly JniPeerMembers _members = new XAPeerMembers ("com/baidu/android/pushservice/PushService", typeof (PushService));
		...
		// Metadata.xml XPath constructor reference: path="/api/package[@name='com.baidu.android.pushservice']/class[@name='PushService']/constructor[@name='PushService' and count(parameter)=0]"
		[Register (".ctor", "()V", "")]
		public unsafe PushService () : base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			const string __id = "()V";
...
#pragma warning disable 0169
		...
		{
			var __this = global::Java.Lang.Object.GetObject<global::Com.Baidu.Android.Pushservice.PushService> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.baidu.android.pushservice']/class[@name='PushService']/method[@name='onBind' and count(parameter)=1 and parameter[1][@type='android.content.Intent']]"
